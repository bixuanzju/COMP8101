...
% Grid computing is gaining more and more attention recently. Simply
% put, grid computing is a form of distributed computing that involves
% coordinating and sharing computing resources across the web globally.
% In this way, exclusive immense computing power previously only
% available to a few organizations now available to everyone. However,
% much research has been focused on infrastructure and middleware, less
% effort is spent in the area of Grid transactions.
